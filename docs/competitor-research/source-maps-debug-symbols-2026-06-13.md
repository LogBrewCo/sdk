...
- Keep expanding native/mobile dry-run manifests before real upload: validate dSYM fat/multi-arch edge cases, PDB, Unity symbols, Android native symbol size/count limits, and richer ELF/Breakpad metadata while keeping source inclusion off by default.
