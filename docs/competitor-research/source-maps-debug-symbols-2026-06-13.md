...
- Keep expanding native/mobile dry-run manifests before real upload: validate dSYM UUID extraction, Android native symbols, PDB, ELF, Breakpad, Unity symbols, and symbol file size/count limits while keeping source inclusion off by default.
