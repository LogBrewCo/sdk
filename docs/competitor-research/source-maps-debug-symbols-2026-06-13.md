...
- Keep expanding native/mobile dry-run manifests before real upload: validate Unity symbols, Android native symbol size/count limits, richer ELF/Breakpad/PDB metadata, and duplicate/richness handling while keeping source inclusion off by default.
