...
- Keep expanding native/mobile dry-run manifests before real upload: validate dSYM UUID extraction, PDB, Breakpad, Unity symbols, Android native symbol size/count limits, and richer ELF metadata while keeping source inclusion off by default.
