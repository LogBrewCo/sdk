...
- Swift still lacks automatic URLSession instrumentation, automatic SwiftUI/UIKit/AppKit lifecycle instrumentation, live OpenTelemetry `Context`/`Span` extraction, baggage/tracestate, rich span events/exceptions, and native symbolication parity.
