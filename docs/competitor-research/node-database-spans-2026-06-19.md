...
- LogBrew still avoids baggage, tracestate, rich span event arrays, DB semantic conventions beyond the current safe subset, query comments, and database-side trace propagation.
