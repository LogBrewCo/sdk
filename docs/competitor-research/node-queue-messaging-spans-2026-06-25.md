...
- Sentry, Datadog, and OpenTelemetry remain stronger for automatic Kafka/AMQP/BullMQ/SQS instrumentation, automatic broker header injection/extraction, batch span links from real message headers, partition/offset diagnostics, data-stream monitoring, baggage/tracestate, and framework-owned queue integrations.
