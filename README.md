...
| Ruby / Rails | [`logbrew-sdk`](ruby/logbrew-ruby) | Shared context, typed exception evidence, automatic request/error/ActiveJob correlation and delivery, stdlib `Logger`, and manual Rack helpers |
