...
class DotnetPublicNugetSmokeTests(unittest.TestCase):
    def test_script_proves_current_public_nuget_package_installs(self) -> None:
        ...
        for expected in (
            ...
            'core_version="${1:-${LOGBREW_NUGET_CORE_VERSION:-${LOGBREW_DOTNET_CORE_VERSION:-0.1.6}}}"',
            ...
            'httpclient_version="${4:-${LOGBREW_NUGET_HTTPCLIENT_VERSION:-${LOGBREW_DOTNET_HTTPCLIENT_VERSION:-0.1.1}}}"',
