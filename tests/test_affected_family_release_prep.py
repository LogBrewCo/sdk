...
class AffectedFamilyReleasePrepTests(unittest.TestCase):
    def test_exact_affected_package_versions_advance(self) -> None:
        npm_versions = {
            "js/logbrew-js/package.json": "0.1.27",
            "js/logbrew-browser/package.json": "0.1.10",
            ...
            "js/logbrew-react-native/package.json": "0.1.34",
        ...
        pypi_versions = {
            "python/logbrew_py/pyproject.toml": ("logbrew-sdk", "0.1.16"),
        ...
        self.assertEqual(rust["package"]["version"], "0.1.7")
        ...
        self.assertEqual(xml_value(ROOT / "java/logbrew-java/pom.xml", "{*}version"), "0.1.8")
    ...
    def test_react_native_release_requires_fixed_core_range_and_updates_native_identity(self) -> None:
        ...
        self.assertEqual(manifest["peerDependencies"]["@logbrew/sdk"], "^0.1.26")
    ...
    def test_release_checker_constants_match_the_affected_version_matrix(self) -> None:
        self.assertEqual(check_release_metadata.RUST_VERSION, "0.1.7")
        ...
        self.assertEqual(check_release_metadata.JAVA_MAVEN_VERSION, "0.1.8")
    ...
    def test_tag_distributed_receipts_match_published_release(self) -> None:
        ...
        self.assertIn('from: "0.1.15"', swift_readme)
    ...
    def test_public_receipt_defaults_match_current_registry_baselines(self) -> None:
        receipt_defaults = {
            ...
            "scripts/real_user_cratesio_public_smoke.sh": ("LOGBREW_CRATESIO_VERSION:-0.1.7",),
            "scripts/real_user_rubygems_public_smoke.sh": ("LOGBREW_RUBYGEMS_VERSION:-0.1.14",),
            ...
            "scripts/real_user_maven_central_public_smoke.sh": (
                "LOGBREW_MAVEN_JAVA_VERSION:-0.1.7",
            ...
            "scripts/real_user_python_public_pypi_smoke.sh": (
                "LOGBREW_PYPI_SDK_VERSION:-0.1.14",
