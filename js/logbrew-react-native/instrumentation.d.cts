...
import type { LogBrewNativeBridgeLike, LogBrewNativeBridgeScope, LogBrewNativeBridgeScopeInput } from "./native-bridge.cjs";
import type { ReactNativeResourceFetchOptions } from "./resource-fetch.cjs";
...
export type ReactNativeInstrumentationOptions<TInput = unknown, TInit = unknown, TResponse = unknown> = {
  ...
  logger?: string;
  measureFetchResponseBodySize?: boolean;
