...
function createNextRouteTemplate({
  pathname,
  routePatterns = [],
  routeTemplate
} = {}) {
...
function createNextNavigationSpanEvent({
  durationMs,
  id,
...
function captureNextNavigation(client, input = {}) {
  if (!client) {
...
function useLogBrewNextNavigation(options = {}) {
