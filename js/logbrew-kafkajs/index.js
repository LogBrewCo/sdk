...
export async function kafkaJsProducerSendBatchWithLogBrewSpan(producer, batch, options = {}) {
...
export function withLogBrewKafkaJsEachMessage(eachMessage, options = {}) {
...
export function withLogBrewKafkaJsEachBatch(eachBatch, options = {}) {
...
export function createLogBrewKafkaJsProducerBatch(batch = {}, traceparent = undefined) {
...
export function createLogBrewKafkaJsMessage(message = {}, traceparent = undefined) {
