...
import { useLogBrew } from "./index.js";

export function createLogBrewReactBrowserContext(client, options = {}) {
  if (!client) {
...
export function useLogBrewBrowserInstrumentation(options = {}) {
