...
export async function captureBrowserResourceTiming(entry, context, options = {}) {
...
export function installLogBrewBrowserResourceTimingInstrumentation(context, options = {}) {
...
export function createBrowserResourceTimingEvent(entry, browserWindow = defaultWindow(), {
