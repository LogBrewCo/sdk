...
function createLogBrewBrowserFetch(context, options = {}) {
...
function installLogBrewBrowserFetchInstrumentation(context, options = {}) {
...
function createBrowserFetchSpanEvent(request, browserWindow = defaultWindow(), {
