...
export async function captureBrowserInteractionTiming(entry, context, options = {}) {
...
export async function captureBrowserInteractionToNextPaint(entries, context, options = {}) {
...
export function installLogBrewBrowserInteractionTimingInstrumentation(context, options = {}) {
...
export function createBrowserInteractionToNextPaintEvent(entries, browserWindow = defaultWindow(), {
...
export function createBrowserInteractionTimingEvent(entry, browserWindow = defaultWindow(), {
...
function defaultInteractionTimingEventId({ message, path }) {
  return createAutomaticBrowserEventId("evt_browser_interaction", `${path}_${message}`);
}

function defaultInteractionToNextPaintEventId({ message, path }) {
  return createAutomaticBrowserEventId("evt_browser_inp", `${path}_${message}`);
}
