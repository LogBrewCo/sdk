...
export function createAutomaticBrowserEventId(prefix, semanticValue) {
...
export function optionalBrowserTraceContext(traceContext) {
...
export function browserTraceMetadata(traceContext, { traceId } = {}) {
