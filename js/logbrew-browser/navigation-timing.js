...
export async function captureBrowserNavigationTiming(entry, context, options = {}) {
...
export function installLogBrewBrowserNavigationTimingInstrumentation(context, options = {}) {
...
export function createBrowserNavigationTimingEvent(entry, browserWindow = defaultWindow(), {
