...
test -f "$tmp_dir/javadoc/co/logbrew/sdk/IssueAttributes.html"
test -f "$tmp_dir/javadoc/co/logbrew/sdk/IssueBreadcrumb.html"
test -f "$tmp_dir/javadoc/co/logbrew/sdk/IssueException.html"
test -f "$tmp_dir/javadoc/co/logbrew/sdk/IssueExceptionMechanism.html"
test -f "$tmp_dir/javadoc/co/logbrew/sdk/IssueStackFrame.html"
...
test -f "$tmp_dir/javadoc/co/logbrew/sdk/LogBrewOpenTelemetrySdk.html"
...
test -f "$tmp_dir/javadoc/co/logbrew/sdk/LogBrewSpringBootExceptionAutoConfiguration.html"
test -f "$tmp_dir/javadoc/co/logbrew/sdk/LogBrewSpringExceptionResolver.html"
...
grep -q '^co/logbrew/sdk/IssueAttributes.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueBreadcrumb.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueDiagnostics.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueException.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueExceptionMechanism.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueStackFrame.java$' "$tmp_dir/sources-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewOpenTelemetrySdk.java$' "$tmp_dir/sources-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewSpringBootExceptionAutoConfiguration.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/LogBrewSpringExceptionResolver.java$' "$tmp_dir/sources-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewSpringBootKafkaAutoConfiguration.java$' "$tmp_dir/sources-jar-contents.txt"
grep -q '^co/logbrew/sdk/LogBrewSpringBootKafkaBeanPostProcessor.java$' "$tmp_dir/sources-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/IssueAttributes.html$' "$tmp_dir/javadoc-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueBreadcrumb.html$' "$tmp_dir/javadoc-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueException.html$' "$tmp_dir/javadoc-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueExceptionMechanism.html$' "$tmp_dir/javadoc-jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueStackFrame.html$' "$tmp_dir/javadoc-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewOpenTelemetrySdk.html$' "$tmp_dir/javadoc-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewSpringBootExceptionAutoConfiguration.html$' "$tmp_dir/javadoc-jar-contents.txt"
grep -q '^co/logbrew/sdk/LogBrewSpringExceptionResolver.html$' "$tmp_dir/javadoc-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewSpringBootKafkaAutoConfiguration.html$' "$tmp_dir/javadoc-jar-contents.txt"
...
grep -q '^co/logbrew/sdk/IssueAttributes.class$' "$tmp_dir/jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueBreadcrumb.class$' "$tmp_dir/jar-contents.txt"
grep -q '^co/logbrew/sdk/IssueDiagnostics.class$' "$tmp_dir/jar-contents.txt"
...
grep -q '^co/logbrew/sdk/LogBrewSpringBootExceptionAutoConfiguration.class$' "$tmp_dir/jar-contents.txt"
grep -q '^co/logbrew/sdk/LogBrewSpringExceptionResolver.class$' "$tmp_dir/jar-contents.txt"
...
grep -q 'LogBrewOpenTelemetrySdk' "$package_dir/README.md"
...
grep -q 'IssueAttributes.fromThrowable' "$package_dir/README.md"
grep -q 'IssueBreadcrumb' "$package_dir/README.md"
grep -q 'LogBrewServletFilter' "$package_dir/README.md"
grep -q 'LogBrewSpringBootAutoConfiguration' "$package_dir/README.md"
grep -q 'LogBrewSpringBootExceptionAutoConfiguration' "$package_dir/README.md"
grep -q 'LogBrewSpringExceptionResolver' "$package_dir/README.md"
grep -q 'logbrew.servlet.capture-exceptions=false' "$package_dir/README.md"
