...
version="${1:-${LOGBREW_RUBYGEMS_VERSION:-0.1.12}}"
...
raise "support ticket draft did not redact diagnostics" unless
  support_diagnostics.values_at("apiKey", "endpoint", "localPath") == ["[redacted]", "[redacted-url]/ingest", "[redacted-path]"]
