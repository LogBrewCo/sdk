...
sdk_version="${LOGBREW_NPM_SDK_VERSION:-0.1.9}"
browser_version="${LOGBREW_NPM_BROWSER_VERSION:-0.1.2}"
node_version="${LOGBREW_NPM_NODE_VERSION:-0.1.7}"
next_version="${LOGBREW_NPM_NEXT_VERSION:-0.1.4}"
react_native_version="${LOGBREW_NPM_REACT_NATIVE_VERSION:-0.1.14}"
