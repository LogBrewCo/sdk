...
bullmq_package_version="$(node -p "require('${repo_root}/js/logbrew-bullmq/package.json').version")"
tmp_dir="$(mktemp -d)"
...
grep -q "@logbrew/bullmq@${bullmq_package_version}" "$tmp_dir/npm-list-depth0.txt"
