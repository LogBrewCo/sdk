...
make -C "$sdk_dir/examples" CC="$cc_command" > "$tmp_dir/examples-help.txt"
...
make -C "$sdk_dir/examples" CC="$cc_command" run-readme-example > "$tmp_dir/readme-example.stdout.json" 2> "$tmp_dir/readme-example.stderr.json"
...
make -C "$sdk_dir/examples" CC="$cc_command" run-real-user-smoke > "$tmp_dir/real-user-smoke.stdout.json" 2> "$tmp_dir/real-user-smoke.stderr.json"
