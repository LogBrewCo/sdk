...
grep -q 'cd examples && make' "$crate_readme"
grep -q 'cd examples && make run-readme-example' "$crate_readme"
grep -q 'cd examples && make run' "$crate_readme"
grep -q 'cd examples && make run-real-user-smoke' "$crate_readme"
