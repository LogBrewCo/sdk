...
grep -q '/Sources/LogBrew/NativeStackFrame.swift$' "$tmp_dir/archive-contents.txt"
...
grep -q '/Tests/LogBrewCrashTests/NativeCrashLifecycleTests.swift$' "$tmp_dir/archive-contents.txt"
grep -q '/Tests/LogBrewCrashTests/NativeCrashFrameCaptureTests.swift$' "$tmp_dir/archive-contents.txt"
grep -q '/Tests/LogBrewCrashTests/NativeCrashFrameCaptureAmbiguityTests.swift$' "$tmp_dir/archive-contents.txt"
...
grep -q 'logbrew debug-artifacts upload' "$tmp_dir/archive-readme.md"
grep -q 'logbrew debug-artifacts lookup' "$tmp_dir/archive-readme.md"
