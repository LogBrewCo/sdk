...
if package_manifest.get("name") != "co.logbrew.unity" or package_manifest.get("version") != "0.2.2":
...
test -f "$installed_package_dir/examples/coroutine_tracker/CoroutineTracker.cs"
