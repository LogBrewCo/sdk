...
grep -q 'Do not ask a person to paste an ingest key' "$tmp_dir/nestjs-readme.md"
grep -q 'Do not treat a missing environment variable as a reason to stop setup' "$tmp_dir/nestjs-readme.md"
grep -q 'Continue without a browser handoff' "$tmp_dir/nestjs-readme.md"
grep -q 'Only stop for account authentication' "$tmp_dir/nestjs-readme.md"
